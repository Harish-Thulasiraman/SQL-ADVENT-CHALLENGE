...
PostgreSQL
--SWFGHOL
SELECT tinsel_colors.color_name, 
       light_colors.color_name,
       CONCAT(tinsel_colors.color_name, '-',light_colors.color_name ) AS result
FROM tinsel_colors
CROSS JOIN light_colors 


--CROSS JOIN doesnt work with same columns using ON
